      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            // Alert popup
            Obx(
              () => controller.showAlertPopup.value
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _Dv(),
          Expanded(flex: 4, child: _TH(label: 'Part No.')),
          _Dv(),
          _TH(width: 58, label: 'Dongle'),
          _Dv(),
          _TH(width: 54, label: 'ECU'),
          _Dv(),
          Expanded(flex: 4, child: _TH(label: 'Progress')),
          _Dv(),
          _TH(width: 56, label: 'Time'),
          _Dv(),
          _TH(width: 76, label: 'Status'),
          _Dv(),
        ...
        child: IntrinsicHeight(
          child: Row(
            ...
            children: [
                ...
                child: Center(
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(color: Color(0x40F97316), blurRadius: 5),
                      ],
                    ),
                    child: Center(
                      child: Text(
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Expanded(
                      child: Center(
                        child: _Pill('Before', _cWhite40, _cWhite15),
                      ),
                    ),
              ...
              Expanded(
                flex: 3,
                child: _BACell(before: device.cvnBefore, after: device.cvn),
              ),
              _Dv(),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        device.flashPercent, // real "0.0%" → "100.0%"
                        textAlign: TextAlign.center,
              ...
              SizedBox(
                width: 76,
                child: Center(child: _StatusBadge(color: device.statusColor)),
              ),
              _Dv(),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // CHECK ECU STATUS button
          // Uses checkEcuStatusButton RxBool — disables during check
          Obx(() {
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      Icons.radar_rounded,
                      color: enabled ? _cWhite : _cWhite40,
                      size: 18,
                    ),
                    const SizedBox(width: 10),
                    Text(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: idle
            ? null
            : [BoxShadow(color: bc.withOpacity(0.18), blurRadius: 5)],
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
